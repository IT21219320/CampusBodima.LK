...
import { useGetOwnerBoardingMutation,useGetKitchenUsersEmailsMutation,useAddKitchenUserMutation,useUpdateKitchenUserMutation,useDeleteKitchenUserMutation,useGetBoardingManagerMutation } from '../slices/ingredientsApiSlice';
...
const OwnerIngredientPage = () => {
    ...
    return (
        <>
                            ...
                            <Col className="mb-3" xs={12} md={12}>
                                <Row>
                                    ...
                                    <InputGroup className="mb-3" style={{ maxWidth: '300px' }}>
                                        ...
                                        readOnly 
                                        />
                                        <Button variant="outline-secondary" id="button-addon2" onClick={() => setShowModal2(true)}>
                                        Manage
                                        </Button>
                                    </InputGroup>
                                    </Col>
            ...
            {/* Merged Modal */}
            <Modal show={showModal2} onHide={handleCloseModal2} size="mg" aria-labelledby="contained-modal-title-vcenter" centered>
                <Modal.Header closeButton>
                ...
                <Modal.Body>
                    ...
                    <Autocomplete
                        ...
                        renderInput={(params) => <TextField {...params} label="Search..." />}
                        onChange={(e, selectedManager) => setNewManagerId(selectedManager ? selectedManager._id : '')} // Set the selected managers ID
                    />
                </Modal.Body>
                <Modal.Footer>
